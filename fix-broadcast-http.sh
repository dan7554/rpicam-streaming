#!/bin/bash
# Update broadcast task to use HTTP for MediaMTX API

set -e

echo "📋 Registering broadcast task definition with correct MediaMTX API settings..."
  ...
  --container-definitions '[
    {
      ...
      "environment": [
        ...
        {"name": "MEDIAMTX_API_PROTOCOL", "value": "http"},
        {"name": "MEDIAMTX_API_PORT", "value": "9997"},
        {"name": "MEDIAMTX_HOST", "value": "3.94.206.123"},
...
echo "✅ Deployment complete! Broadcast should now connect to MediaMTX via HTTP"
